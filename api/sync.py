...
def _resolve_paths(db_path: str):
    ...
    # GMAIL_SYNC_MAIN env var overrides the default path resolution.
    # Set it in .env or your environment to point at gmail-to-sqlite/main.py.
    main_py = os.environ.get("GMAIL_SYNC_MAIN") or os.path.join(
        os.path.dirname(data_dir), "main.py"
    )
    workspace_root = os.path.dirname(main_py)
